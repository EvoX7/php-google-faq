...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-8 offset-2 text-left">
          ...
          foreach ($faqs as $faq) {
          ?>
            <h4 class="fw-bold mb-3 mt-5"><?php echo  $faq['question']; ?></h4>
  ...
  <footer>
    <div class="container d-flex justify-content-around align-items-center">
      <ul class="list-group list-group-horizontal list-unstyled me-5 mt-2">
        <li class="ms-2">Google&nbsp;&nbsp; -</li>
        <li class="ms-2">About Google&nbsp;&nbsp; -</li>
        <li class="ms-2">Privacy&nbsp;&nbsp; -</li>
        <li class="ms-2">Terms</li>
      </ul>
      <div class="d-flex mt-2">
        <div><img class="eu_flag" src="https://www.nationsonline.org/flags_big/EU_lgflag.gif" alt="europe"></div>
